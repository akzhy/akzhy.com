...
/** Connection between the RootQuery type and the shelf type */
export type RootQueryToShelfConnection = Connection &
  ShelfConnection & {
...
/** An edge in a connection */
export type RootQueryToShelfConnectionEdge = Edge &
  ShelfConnectionEdge & {
...
export type RootQueryToShelfConnectionPageInfo = PageInfo &
  ShelfConnectionPageInfo &
  WpPageInfo & {
...
/** Connection between the Shelf type and the shelf type */
export type ShelfToParentConnectionEdge = Edge &
  OneToOneConnection &
  ShelfConnectionEdge & {
...
/** Connection between the Shelf type and the shelf type */
export type ShelfToPreviewConnectionEdge = Edge &
  OneToOneConnection &
  ShelfConnectionEdge & {
...
/** Connection between the Shelf type and the shelf type */
export type ShelfToShelfConnection = Connection &
  ShelfConnection & {
...
/** An edge in a connection */
export type ShelfToShelfConnectionEdge = Edge &
  ShelfConnectionEdge & {
...
export type ShelfToShelfConnectionPageInfo = PageInfo &
  ShelfConnectionPageInfo &
  WpPageInfo & {
  ...
  shelfItems?: {
    ...
    edges: Array<{
      ...
      node: {
        ...
        title?: string | null;
        date?: string | null;
        acf?: { __typename?: "Acf"; description?: string | null } | null;
        featuredImage?: {
          __typename?: "NodeWithFeaturedImageToMediaItemConnectionEdge";
          node: {
            __typename?: "MediaItem";
...
export const IndexMainDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "IndexMain" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "hero_image" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "seo_description" },
                      },
                    ],
                  },
                },
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "shelfItems" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
...
} as unknown as DocumentNode<IndexMainQuery, IndexMainQueryVariables>;
