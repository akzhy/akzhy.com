...
export default function BlogItem({id,title,featured_image,date,slug, description}:Props) {
    return (
        <a className="bg-bg-secondary block text-fg-primary my-8 rounded overflow-hidden border-4 border-transparent focus:border-primary focus:outline-none duration-300 transition-all hover:border-secondary" title={title} href={`/blog/${slug}`}>
